...
const Login = () => {
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm relative items-center block max-w-sm p-6 bg-white dark:bg-gray-100 border border-gray-100 rounded-lg shadow-md">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* spinner use 1 try */}
          {status === 'loading' && (
            <div role="status" class="absolute -translate-x-1/2 -translate-y-1/2 top-1/4 left-1/2">
          ...
          <div>
            <button type="submit" disabled={status === 'loading'} className="cursor-pointer flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
              Войти
            </button>
          </div>
        </form>
